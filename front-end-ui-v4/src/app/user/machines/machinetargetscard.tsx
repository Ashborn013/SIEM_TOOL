    ...
    <Card className="overflow-hidden">
      ...
      <CardContent className="p-0">
        <Tabs defaultValue="system" className="w-full">
          <TabsList className="w-full rounded-none justify-start px-6 pt-2">
          ...
          <TabsContent value="network" className="p-6 pt-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  {machine.ips.map((ip, i) => (
                    <Badge key={i} variant="secondary" className="justify-start font-mono text-xs">
                      {ip}
                    </Badge>
                  ))}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium capitalize">{machine.os.platform}</span>
                    </div>
                  </div>
                </div>
