...
export function SpecialPrivilegeLogonsTable() {
  const [rows, setRows] = useState([])

  useEffect(() => {
    function fetchSpecialPrivilegeLogons() {
    ...
    fetchSpecialPrivilegeLogons()
    const intervalId = setInterval(fetchSpecialPrivilegeLogons, INTERVAL_TIME)
